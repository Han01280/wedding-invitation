...
const CONFIG = {
  ...
  // 사이트 완성 전 임시 비활성화: true로 두면 "준비 중입니다" 안내 화면만 보이고
  // 실제 청첩장 내용은 전혀 렌더링되지 않습니다. QR코드/주소는 그대로 유지되니
  // 완성되면 이 값만 false로 바꿔서 다시 배포하면 됩니다.
  comingSoon: false,
  ...
  // 갤러리
  gallery: Array.from({ length: 27 }, (_, i) => `images/gallery${i + 1}.jpg`),

  // 오시는 길
  map: {
    name: '천안 비렌티 웨딩홀 · 신관 3층 루체오홀',
    venueName: '천안 비렌티 웨딩홀',
    hallName: '신관 3층ㆍ루체오홀',
    shortLine: '천안 비렌티 웨딩홀ㆍ 루체오홀',
    ...
    transport: {
      shuttle: {
        steps: [
          { text: '천안종합터미널', sub: '탑승장소: 아라리오갤러리 올리브영 & 스타벅스 앞 횡단보도' },
          { text: '두정역', sub: '탑승장소: 1번 출구 우측 50m 지점 파란색 셔틀버스 승강장' },
        ],
        notes: [
      ...
      srtKtx: {
        steps: [
          { text: '천안아산역 하차', sub: '택시 이용 20분 내외' },
        ],
      },
    },
  },
  ...
  share: {
    ...
    kakaoThumbnail: 'https://wedding-invitation-kappa-three-94.vercel.app/images/kakao-cover-v4.jpg',
  },
};
