...
const CONFIG = {
  ...
  map: {
    ...
    transport: {
      shuttle: {
        steps: [
          '천안종합터미널 : 아라리오갤러리 올리브영 & 스타벅스 앞 횡단보도',
          '두정역 : 1번 출구 우측 50m 지점 파란색 셔틀버스 승강장',
        ],
        notes: [
      ...
      bus: {
        steps: [
          ...
          { text: '천안고속버스터미널 (맥도날드 앞)', sub: '112번, 140번, 141번, 143번, 144번, 145번, 150번, 151번' },
        ],
        notes: [
  ...
  // 안내사항 (자유롭게 추가/삭제 가능)
  information: [
    { title: '식사 안내', content: '2층 연회장에 뷔페가 준비되어 있습니다.\n식권은 축의대에서 수령해 주세요.' },
  ],
