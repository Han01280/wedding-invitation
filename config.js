...
const CONFIG = {
  ...
  intro: {
    ...
    venueShort: '천안 비렌티 웨딩홀 · 신관 3층 루체오홀',
    message: [
      '함께 맞이하는 열 번째 겨울,\n저희 두 사람 결혼합니다.',
  ...
  map: {
    ...
    transport: {
      ...
      bus: {
        steps: [
          { text: '천안역(양지문고 앞)', sub: '100번, 110번, 112번, 82번' },
          { text: '터미널(신세계백화점 앞)', sub: '112번, 140번, 141번, 143번, 144번, 145번, 150번, 151번' },
        ],
        notes: [
          '성환방면 100번대 버스 이용 시 천안공주대학교에서 하차 후 도보 5분',
        ],
      },
    },
  },
